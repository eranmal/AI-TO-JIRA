...
You must compare the provided Existing UML Structure with the New Assignment Specification and explicitly create User Stories, Tasks, and Sub-tasks that handle the migration, refactoring, or full rewriting of components using a STRICT Test-Driven Development (TDD) and multi-tier testing pipeline:
